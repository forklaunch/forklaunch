...
- Updated dependencies
  - @forklaunch/implementation-messaging-base@1.1.4
  - @forklaunch/interfaces-messaging@1.1.4
...
- Updated dependencies
  - @forklaunch/implementation-messaging-base@1.1.3
  - @forklaunch/interfaces-messaging@1.1.3
...
- Updated dependencies
  - @forklaunch/implementation-messaging-base@1.1.2
  - @forklaunch/interfaces-messaging@1.1.2
...
- Updated dependencies
  - @forklaunch/implementation-messaging-base@1.1.1
  - @forklaunch/interfaces-messaging@1.1.1

## 1.1.0

### Minor Changes

- fe8b16e: Add messaging module: SmsService interface with a base implementation (persists and logs instead of dispatching) and a Twilio implementation (dependency-free Messages REST API dispatch via fetch plus delivery status callback mapping).
...
- Updated dependencies [fe8b16e]
- Updated dependencies [927378c]
  - @forklaunch/interfaces-messaging@1.1.0
  - @forklaunch/implementation-messaging-base@1.1.0
