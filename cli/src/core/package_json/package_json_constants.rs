...
// @types/node
pub(crate) const TYPES_NODE_VERSION: &str = "^25.5.2";
// jest
...
// typescript-eslint
pub(crate) const TYPESCRIPT_ESLINT_VERSION: &str = "^8.58.1";
// vitest
pub(crate) const VITEST_VERSION: &str = "^4.1.3";

// Application package.json dependencies constants
// @typescript/native-preview
pub(crate) const TYPESCRIPT_NATIVE_PREVIEW_VERSION: &str = "7.0.0-dev.20260408.1";
// globals
...
// @forklaunch/common
pub(crate) const COMMON_VERSION: &str = "~1.2.16";
// @forklaunch/core
pub(crate) const CORE_VERSION: &str = "~1.5.0";
// @forklaunch/express
pub(crate) const EXPRESS_VERSION: &str = "~1.2.30";
// @forklaunch/hyper-express
pub(crate) const HYPER_EXPRESS_VERSION: &str = "~1.2.30";
// @forklaunch/implementation-billing-base
pub(crate) const BILLING_BASE_VERSION: &str = "~1.0.24";
// @forklaunch/implementation-billing-stripe
pub(crate) const BILLING_STRIPE_VERSION: &str = "~1.1.24";
// @forklaunch/implementation-iam-base
pub(crate) const IAM_BASE_VERSION: &str = "~1.0.24";
// @forklaunch/implementation-worker-bullmq
pub(crate) const WORKER_BULLMQ_VERSION: &str = "~1.0.25";
// @forklaunch/implementation-worker-redis
pub(crate) const WORKER_REDIS_VERSION: &str = "~1.0.25";
// @forklaunch/implementation-worker-database
pub(crate) const WORKER_DATABASE_VERSION: &str = "~1.0.25";
// @forklaunch/implementation-worker-kafka
pub(crate) const WORKER_KAFKA_VERSION: &str = "~1.0.25";
// @forklaunch/infrastructure-redis
pub(crate) const INFRASTRUCTURE_REDIS_VERSION: &str = "~1.4.2";
// @forklaunch/infrastructure-s3
pub(crate) const INFRASTRUCTURE_S3_VERSION: &str = "~1.4.2";
// @forklaunch/interfaces-billing
pub(crate) const BILLING_INTERFACES_VERSION: &str = "~1.0.23";
// @forklaunch/interfaces-iam
pub(crate) const IAM_INTERFACES_VERSION: &str = "~1.0.23";
// @forklaunch/interfaces-worker
pub(crate) const WORKER_INTERFACES_VERSION: &str = "~1.0.23";
// @forklaunch/internal
pub(crate) const INTERNAL_VERSION: &str = "~1.2.16";
// @forklaunch/testing
pub(crate) const TESTING_VERSION: &str = "~1.2.16";
// @forklaunch/universal-sdk
pub(crate) const UNIVERSAL_SDK_VERSION: &str = "~1.2.16";
// @forklaunch/validator
pub(crate) const VALIDATOR_VERSION: &str = "~1.2.16";
// @mikro-orm/core
pub(crate) const MIKRO_ORM_CORE_VERSION: &str = "7.0.9";
// @mikro-orm/migrations
pub(crate) const MIKRO_ORM_MIGRATIONS_VERSION: &str = "7.0.9";
...
pub(crate) const MIKRO_ORM_DATABASE_VERSION: &str = "7.0.9";
// @mikro-orm/seeder
pub(crate) const MIKRO_ORM_SEEDER_VERSION: &str = "7.0.9";
// @opentelemetry/api
...
// better-auth
pub(crate) const BETTER_AUTH_VERSION: &str = "^1.6.1";
// bullmq
pub(crate) const BULLMQ_VERSION: &str = "^5.73.1";
// better-sqlite3
pub(crate) const BETTER_SQLITE3_VERSION: &str = "^12.8.0";
// dotenv
pub(crate) const DOTENV_VERSION: &str = "^17.4.1";
// jose
pub(crate) const JOSE_VERSION: &str = "^6.2.2";
// sqlite3
pub(crate) const SQLITE3_VERSION: &str = "^6.0.1";
// stripe
pub(crate) const STRIPE_VERSION: &str = "^22.0.1";
// uuid
...
// @mikro-orm/cli
pub(crate) const MIKRO_ORM_CLI_VERSION: &str = "7.0.9";
// @types/express
