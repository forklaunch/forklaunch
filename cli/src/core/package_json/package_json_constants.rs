...
// typescript-eslint
pub(crate) const TYPESCRIPT_ESLINT_VERSION: &str = "^8.58.0";
// vitest
pub(crate) const VITEST_VERSION: &str = "^4.1.3";

// Application package.json dependencies constants
// @typescript/native-preview
pub(crate) const TYPESCRIPT_NATIVE_PREVIEW_VERSION: &str = "7.0.0-dev.20260407.1";
// globals
...
// @forklaunch/common
pub(crate) const COMMON_VERSION: &str = "~1.2.15";
// @forklaunch/core
pub(crate) const CORE_VERSION: &str = "~1.4.1";
// @forklaunch/express
pub(crate) const EXPRESS_VERSION: &str = "~1.2.29";
// @forklaunch/hyper-express
pub(crate) const HYPER_EXPRESS_VERSION: &str = "~1.2.29";
// @forklaunch/implementation-billing-base
pub(crate) const BILLING_BASE_VERSION: &str = "~1.0.23";
// @forklaunch/implementation-billing-stripe
pub(crate) const BILLING_STRIPE_VERSION: &str = "~1.1.23";
// @forklaunch/implementation-iam-base
pub(crate) const IAM_BASE_VERSION: &str = "~1.0.23";
// @forklaunch/implementation-worker-bullmq
pub(crate) const WORKER_BULLMQ_VERSION: &str = "~1.0.24";
// @forklaunch/implementation-worker-redis
pub(crate) const WORKER_REDIS_VERSION: &str = "~1.0.24";
// @forklaunch/implementation-worker-database
pub(crate) const WORKER_DATABASE_VERSION: &str = "~1.0.24";
// @forklaunch/implementation-worker-kafka
pub(crate) const WORKER_KAFKA_VERSION: &str = "~1.0.24";
// @forklaunch/infrastructure-redis
pub(crate) const INFRASTRUCTURE_REDIS_VERSION: &str = "~1.4.1";
// @forklaunch/infrastructure-s3
pub(crate) const INFRASTRUCTURE_S3_VERSION: &str = "~1.4.1";
// @forklaunch/interfaces-billing
pub(crate) const BILLING_INTERFACES_VERSION: &str = "~1.0.22";
// @forklaunch/interfaces-iam
pub(crate) const IAM_INTERFACES_VERSION: &str = "~1.0.22";
// @forklaunch/interfaces-worker
pub(crate) const WORKER_INTERFACES_VERSION: &str = "~1.0.22";
// @forklaunch/internal
pub(crate) const INTERNAL_VERSION: &str = "~1.2.15";
// @forklaunch/testing
pub(crate) const TESTING_VERSION: &str = "~1.2.15";
// @forklaunch/universal-sdk
pub(crate) const UNIVERSAL_SDK_VERSION: &str = "~1.2.15";
// @forklaunch/validator
pub(crate) const VALIDATOR_VERSION: &str = "~1.2.15";
// @mikro-orm/core
...
// better-auth
pub(crate) const BETTER_AUTH_VERSION: &str = "^1.6.0";
// bullmq
pub(crate) const BULLMQ_VERSION: &str = "^5.73.0";
// better-sqlite3
...
// stripe
pub(crate) const STRIPE_VERSION: &str = "^22.0.0";
// uuid
