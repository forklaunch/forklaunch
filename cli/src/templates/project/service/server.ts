...
import { complianceRouter } from './api/routes/compliance.routes';{{/is_iam_configured}}
...
async function startServer() {
  ...
  app.use({{camel_case_name}}Router);{{#is_database_enabled}}{{#is_iam_configured}}
  app.use(complianceRouter);{{/is_iam_configured}}{{/is_database_enabled}}
