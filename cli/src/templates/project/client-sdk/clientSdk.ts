...
import type { CacSdkClient } from "@{{app_name}}/cac";{{/is_cac}}{{#is_mlse}}
import type { MlseSdkClient } from "@{{app_name}}/mlse";{{/is_mlse}}
...
export const cacSdkClient = universalSdk<CacSdkClient>;{{/is_cac}}{{#is_mlse}}
export const mlseSdkClient = universalSdk<MlseSdkClient>;{{/is_mlse}}
